...
const resources = {
  en: {
    translation: {
      ...
      dashboard: { title: 'Dashboard', subtitle: 'Overview of your store performance', totalUsers: 'Total Users', totalOrders: 'Total Orders', totalProducts: 'Total Products', totalRevenue: 'Total Revenue', revenueByMonth: 'Revenue by Month', orderStatus: 'Order Status', categoryShare: 'Product Categories', usersByMonth: 'Users by Month' },
      ...
      messages: { deleteConfirm: 'Are you sure you want to delete selected records?', loadError: 'Failed to load data.', updateError: 'Failed to update.', importSuccess: 'Import completed.', syncCart: 'Guest cart synced.' }
      ,
      public: {
  ...
  vi: {
    translation: {
      ...
      dashboard: { title: 'Bảng điều khiển', subtitle: 'Tổng quan hiệu quả kinh doanh cửa hàng', totalUsers: 'Tổng người dùng', totalOrders: 'Tổng đơn hàng', totalProducts: 'Tổng sản phẩm', totalRevenue: 'Tổng doanh thu', revenueByMonth: 'Doanh thu theo tháng', orderStatus: 'Trạng thái đơn hàng', categoryShare: 'Sản phẩm theo danh mục', usersByMonth: 'Người dùng theo tháng' },
      ...
      messages: { deleteConfirm: 'Bạn có chắc muốn xóa các bản ghi đã chọn?', loadError: 'Không thể tải dữ liệu.', updateError: 'Không thể cập nhật.', importSuccess: 'Nhập file thành công.', syncCart: 'Đã đồng bộ giỏ hàng khách.' }
      ,
      public: {
