...
const resources = {
  en: {
    translation: {
      ...
      dashboard: { title: 'Dashboard', subtitle: 'Overview of your store performance', totalUsers: 'Total Users', totalOrders: 'Total Orders', totalProducts: 'Total Products', totalRevenue: 'Total Revenue', revenueByMonth: 'Revenue by Month', orderStatus: 'Order Status', categoryShare: 'Product Categories' },
  ...
  vi: {
    translation: {
      ...
      dashboard: { title: 'Bảng điều khiển', subtitle: 'Tổng quan hiệu quả kinh doanh cửa hàng', totalUsers: 'Tổng người dùng', totalOrders: 'Tổng đơn hàng', totalProducts: 'Tổng sản phẩm', totalRevenue: 'Tổng doanh thu', revenueByMonth: 'Doanh thu theo tháng', orderStatus: 'Trạng thái đơn hàng', categoryShare: 'Tỉ trọng danh mục' },
